...
int printf_width(const char *format, int *i, va_list list);
...
int handlef_write_char(char c, char buffer[],
	int flags, int width, int precision, int size);
int writef_number(int is_positive, int ind, char buffer[],
	int flags, int width, int precision, int size);
int writef_num(int ind, char bff[], int flags, int width, int precision,
